...
client.on('message', msg => {
  if (!msg.content.startsWith('!votemute') || msg.author.bot)
    return;
  ...
  if (args == "") {
    ...
    setTimeout(function() {
      member.roles.remove('652102004654735380').catch(console.error)
    }, 120000, 'funky');
    ...
    console.log("Mute voted for " + args + " " + voteCounts[args] + "/5");
    msg.channel.send("Vote has been counted! Currently there are " +
                     voteCounts[args] + " votes. ");
  }
});
